...
def generateCoverageInfo(source, target, env):
    ...
    os.system("lcov --remove lcov.info '*/tool-unity/*' '*/test/*' '*/MockArduino/*' '*/usr/include/*' -o filtered_lcov.info")
    os.system("mkdir -p cov && genhtml -o cov --demangle-cpp filtered_lcov.info")
